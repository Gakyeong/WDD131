...
function recipeTemplate(recipe) {
      return `<img class="contentimg" src="${recipe.image}">
                <div class="block2">
                  <div class="tagitem">
                        <span class="tag">${tagsTemplate(recipe)}</span>
                  </div>
                    <h3 class="name">${recipe.name}</h2>
...
function toolTemplate(tool) {
      return `<img class="contentimg" src="${tool.image}">
                <div class="block2">
                  <div class="tagitem">
                        <span class="tag">${tagsTemplate(tool)}</span>
                  </div>
